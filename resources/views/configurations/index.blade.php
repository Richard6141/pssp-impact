            ...
            <form method="POST" id="editSiteForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="edit_site_departement" name="site_departement" required>
                    </div>
                    <div class="mb-3">
            ...
            <form method="POST" id="editTypeForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="edit_type_description" name="description" rows="3"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
