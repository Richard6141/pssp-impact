    ...
    <section class="section">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">{{ isset($facture) ? 'Ã‰dition' : 'CrÃ©ation' }} de facture</h5>
                        ...
                        <form class="row g-3" method="POST" enctype="multipart/form-data"
                                ...
                                <div id="collectesContainer" class="border rounded p-3"
                                    ...
                                    <div class="form-check mb-1">
                                        ...
                                        <label class="form-check-label" for="collecte_{{ $collecte->collecte_id }}">
                                            ...
                                            â€”
                                            {{ $collecte->typeDechet?->libelle ?? 'Type inconnu' }} â€”
                                            {{ $collecte->poids }} Kg
                                        </label>
                                    </div>
                                    @endforeach
                            ...
                            <div class="text-center mt-3">
                                <button type="submit" class="btn btn-primary">
                                    {{ isset($facture) ? 'Mettre Ã  jour' : 'Ajouter' }}
                                </button>
