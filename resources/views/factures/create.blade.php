...
<script>
    ...
    document.getElementById('siteSelect').addEventListener('change', function() {
        ...
        if (siteId) {
            ...
            container.innerHTML =
                '<p class="text-muted">S�lectionnez un site pour voir les collectes disponibles.</p>';
        }
    });

    // Charger les collectes au chargement de la page si un site est d�j� s�lectionn�
